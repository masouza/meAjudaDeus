...
public class TelaFuncionario extends JFrame {
    ...
    public TelaFuncionario(ControladorGeral owner) {
        super("Funcionario");
    ...
    public void configura() {
        ...
        buttonAdd.addActionListener(new ActionListener() {
            ...
            owner.getControladorFuncionario().getTelaAddFuncionario().inicia();
            fecha();
            }
        });
        ...
        buttonList.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                owner.getControladorFuncionario().getTelaMostraFuncionarios().inicia();
                fecha();
            }
        });
